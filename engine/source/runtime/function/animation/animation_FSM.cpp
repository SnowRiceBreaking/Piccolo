    ...
    bool AnimationFSM::update(const json11::Json::object& signals)
    {
        ...
        switch (m_state)
        {
            ...
            case States::_walk_stop:
                ...
                {
                //    std::cout << "is work stop" << std::endl;
                    m_state = States::_idle;
                }
                break;
            ...
            //    std::cout << "_jump_start_from_idle" << std::endl;
                break;
        ...
        //        std::cout << "_jump_loop_from_idle" << std::endl;
                break;
        ...
        //        std::cout << "_jump_end_from_idle" << std::endl;
                break;
